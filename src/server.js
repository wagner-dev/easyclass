...
const horario = require('./standard/horario/index.json')
...
async function start(link, end) {
    ...
    await page.type('.whsOnd.zHQkBf', '[COLOQUE SEU EMAIL AQUI]')
    ...
    setTimeout(async () => {
        ...
        await page.type('.whsOnd.zHQkBf', '[COLOQUE SUA SENHA AQUI]')
        await page.click('.VfPpkd-LgbsSe.VfPpkd-LgbsSe-OWXEXe-k8QpJ.VfPpkd-LgbsSe-OWXEXe-dgl2Hf.nCP5yc.AjY5Oe.DuMIQc.qIypjc.TrZEUc.lw1w4b')
            ...
            if(chat.length){
                ...
                if(lastChat.includes('presente')){
                    ...
                    let context = new AudioContext(),
                        ...
                        alert('Alguém mandou uma msg no chat sobre a presença. Provavelmente, a chamada começou!')
                        oscillator.stop()
                }
            }
        }, 1000)
